...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, LOWER, KC_LGUI, KC_LALT, RAISE, KC_SPC,  KC_SPC,  RAISE,  KC_MPLY, KC_LEFT, KC_DOWN, KC_RGHT  \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN,  KC_SLSH, KC_VOLU, KC_SLSH, \
